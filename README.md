...
```
$ git clone https://github.com/cypherpunk-0777/docker-ubuntu-openbox-vnc.git
$ docker build --rm -t cypherpunk-0777/docker-ubuntu-openbox-vnc docker-ubuntu-openbox-vnc
```
...
### Use it headless
```
$ docker run -it cypherpunk-0777/docker-ubuntu-openbox-vnc
```
Now you can use the command line

### Use it with ssh
```
$ docker run -it -p [port]:22 cypherpunk-0777/docker-ubuntu-openbox-vnc
```
...
```
$ docker run -it -p [port]:22 -e SSHPW=[YOUR_PW] cypherpunk-0777/docker-ubuntu-openbox-vnc
```
...
### Use it with vnc
```
$ docker run -i -t -p 5900:5900 cypherpunk-0777/docker-ubuntu-openbox-vnc
```
if you want to set resolution
```
$ docker run -i -t -p 5900:5900 -e RESOLUTION=1920x1080 cypherpunk-0777/docker-ubuntu-openbox-vnc
```
...
```
$ docker run -it -P cypherpunk-0777/docker-ubuntu-openbox-vnc
```
...
## Original credits
 https://github.com/OptSolution/docker-ubuntu-openbox-vnc.git
